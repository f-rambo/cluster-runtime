...
var file_api_service_service_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0x8c, 0x02,
	...
	,
}
...
var file_api_service_service_proto_depIdxs = []int32{
	...
	1, // 1: clusterruntime.api.service.ServiceInterface.GetSerice:input_type -> biz.service.Service
	2, // 2: clusterruntime.api.service.ServiceInterface.CommitWorklfow:input_type -> biz.service.Workflow
	2, // 3: clusterruntime.api.service.ServiceInterface.GetWorkflow:input_type -> biz.service.Workflow
	3, // 4: clusterruntime.api.service.ServiceInterface.ApplyService:output_type -> common.Msg
	1, // 5: clusterruntime.api.service.ServiceInterface.GetSerice:output_type -> biz.service.Service
	3, // 6: clusterruntime.api.service.ServiceInterface.CommitWorklfow:output_type -> common.Msg
	2, // 7: clusterruntime.api.service.ServiceInterface.GetWorkflow:output_type -> biz.service.Workflow
