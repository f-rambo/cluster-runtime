...
const (
	...
	ServiceInterface_CleanWorkflow_FullMethodName  = "/clusterruntime.api.service.ServiceInterface/CleanWorkflow"
)
...
type ServiceInterfaceClient interface {
	...
	CleanWorkflow(ctx context.Context, in *biz.Workflow, opts ...grpc.CallOption) (*common.Msg, error)
}
...
func (c *serviceInterfaceClient) CleanWorkflow(ctx context.Context, in *biz.Workflow, opts ...grpc.CallOption) (*common.Msg, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(common.Msg)
	err := c.cc.Invoke(ctx, ServiceInterface_CleanWorkflow_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ServiceInterfaceServer interface {
	...
	CleanWorkflow(context.Context, *biz.Workflow) (*common.Msg, error)
...
func (UnimplementedServiceInterfaceServer) CleanWorkflow(context.Context, *biz.Workflow) (*common.Msg, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CleanWorkflow not implemented")
}
...
func _ServiceInterface_CleanWorkflow_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(biz.Workflow)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ServiceInterfaceServer).CleanWorkflow(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ServiceInterface_CleanWorkflow_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServiceInterfaceServer).CleanWorkflow(ctx, req.(*biz.Workflow))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ServiceInterface_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ServiceInterface_CleanWorkflow_Handler,
		},
	},
